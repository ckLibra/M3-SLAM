...
from geom.losses import geodesic_loss, residual_loss, flow_loss, depth_loss
    ...
    while should_keep_training:
        for i_batch, item in enumerate(train_loader):
            ...
            while r < args.restart_prob:
                ...
                depth_loss, depth_metrics = losses.depth_loss(disps, disps_est)
                ...
                loss = args.w1 * geo_loss + args.w2 * res_loss + args.w3 * flo_loss + args.w4 * depth_loss
                loss.backward()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--w4', type=float, default=10.0)
